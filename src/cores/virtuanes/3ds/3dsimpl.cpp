...
SMenuItem optionMenu[] = {
    ...
    MENU_MAKE_DISABLED  (""),
    MENU_MAKE_PICKER    (69696, "  调色板", "选取您喜爱的NES调色板", optionsForPalette, Themes[settings3DS.Theme].dialogColorInfo),
    MENU_MAKE_DISABLED  (""),
    ...
    MENU_MAKE_PICKER    (12000, "  帧率", "某些游戏默认运行于 50 或 60 FPS. 可在需要时覆盖帧率设置.", optionsForFrameRate, Themes[settings3DS.Theme].dialogColorInfo),
    MENU_MAKE_PICKER    (19000, "  精灵闪烁", "精灵在实机上将会闪烁. 您可以禁用以获得更好的视觉效果.", optionsForSpriteFlicker, Themes[settings3DS.Theme].dialogColorInfo),
    MENU_MAKE_DISABLED  (""),
...
SMenuItem controlsMenu[] = {
    ...
    MENU_MAKE_PICKER    (23003, "为1P投币 (VS Games)", "", optionsFor3DSButtons, Themes[settings3DS.Theme].dialogColorInfo),
    MENU_MAKE_PICKER    (23004, "为2P投币 (VS Games)", "", optionsFor3DSButtons, Themes[settings3DS.Theme].dialogColorInfo),
    MENU_MAKE_LASTITEM  ()
};
...
SMenuItem emulatorMenu[] = {
    ...
    MENU_MAKE_PICKER2   (30000,"  选择磁盘", "", optionsForDisk, Themes[settings3DS.Theme].dialogColorInfo),
    MENU_MAKE_HEADER2   (""),
