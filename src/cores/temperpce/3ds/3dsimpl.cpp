...
SMenuItem optionsForButtons[] = {
    MENU_MAKE_DIALOG_ACTION (0,                 getText("无"),             ""),
    MENU_MAKE_DIALOG_ACTION (IO_BUTTON_I,       getText("I键"),            ""),
    MENU_MAKE_DIALOG_ACTION (IO_BUTTON_II,      getText("II键"),           ""),
    MENU_MAKE_DIALOG_ACTION (IO_BUTTON_III,     getText("III键"),          ""),
    MENU_MAKE_DIALOG_ACTION (IO_BUTTON_IV,      getText("IV键"),           ""),
    MENU_MAKE_DIALOG_ACTION (IO_BUTTON_V,       getText("V键"),            ""),
    MENU_MAKE_DIALOG_ACTION (IO_BUTTON_VI,      getText("VI键"),           ""),
    MENU_MAKE_DIALOG_ACTION (IO_BUTTON_SELECT,  getText("PCE SELECT键"),   ""),
    MENU_MAKE_DIALOG_ACTION (IO_BUTTON_RUN,     getText("PCE RUN键"),      ""),
    MENU_MAKE_LASTITEM  ()
};
...
SMenuItem optionMenu[] = {
    ...
    MENU_MAKE_PICKER    (22000, getText("  CPU核心"), getText("游戏出现卡死时可选择原生CPU核心"), optionsForCPUCore, DIALOG_TYPE_INFO),
    MENU_MAKE_PICKER    (20000, getText("  空闲态循环补丁"), getText("改变此项配置后需重启ROM"), optionsForIdleLoopPatch, DIALOG_TYPE_INFO),
    MENU_MAKE_PICKER    (10000, getText("  跳帧"), getText("跳帧可以加快游戏速度,但可能会导致画面不平滑"), optionsForFrameskip, DIALOG_TYPE_INFO),
    MENU_MAKE_PICKER    (21000, "  BIOS", getText("BIOS文件必须放置在根目录的 /emus3ds/temperpce_3ds/syscards 文件夹. 改变此项配置后将重启ROM"), optionsForBIOS, DIALOG_TYPE_INFO),
    MENU_MAKE_PICKER    (16000, getText("  调色板修复"), getText("可尝试更改此项,若游戏画面中某些颜色不正确"), optionsForPaletteFix, DIALOG_TYPE_INFO),
    MENU_MAKE_DISABLED  (""),
...
SMenuItem controlsMenu[] = {
    ...
    MENU_MAKE_CHECKBOX  (50000, getText("  为所有游戏映射按键"), 0),
    MENU_MAKE_CHECKBOX  (50001, getText("  为所有游戏映射连发按键"), 0),
    MENU_MAKE_DISABLED  (""),
...
// menu.
//---------------------------------------------------------
const char *impl3dsTitleText = "TemperPCE for 3DS v1.04R";
